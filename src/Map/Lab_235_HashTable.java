...
public class Lab_235_HashTable  {
    public static void main(String[] args) {
        // Map - K, V,  null values are not  allowed
        ...
        //Both key and values does not supports null values
...
//HashTable is a legacy class will supports enumeration
